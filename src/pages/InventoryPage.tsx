      ...
      <div className="bg-white rounded-xl border border-slate-200 p-4 shadow-xs flex flex-col md:flex-row items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2.5 w-full md:w-auto justify-between md:justify-end">
          ...
          <button
            ...
            className="px-3 py-2 text-xs font-semibold text-[#005f60] bg-teal-50 hover:bg-teal-100/70 border border-teal-200 rounded-lg shadow-2xs transition-colors flex items-center gap-1.5"
          >
                  ...
                  <tr key={item.id} className="hover:bg-slate-50/80 transition-colors divide-x divide-slate-100">
                    ...
                    <td className="px-3.5 py-2.5 text-center">
                      ...
                      <div className="text-[10px] text-slate-400">
                        {item.availableQuantity === 0 ? 'Exhausted' : 'Available'}
                      </div>
                    </td>
                    ...
                    <td className="px-3.5 py-2.5 text-right">
                      <div className="flex items-center justify-end gap-1.5">
                        {/* "Adjust Stock" button hidden — modal/logic below kept intact, see PROJECT_STATUS.md */}
